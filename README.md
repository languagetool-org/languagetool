...
* How to use via HTTP: http://wiki.languagetool.org/public-http-api
* Full HTTP API documentation: https://languagetool.org/http-api/swagger-ui/#/
* How to use from Java: http://wiki.languagetool.org/java-api
