...
public class UnsyncStack<E> extends ArrayList<E> {
   ...
   * object <code>o</code> occurs as an item in this stack, this method returns the
   ...
   * <code>1</code>. The <code>equals</code> method is used to compare <code>o</code> to the
   * items in this stack.
   * 
   * @param o
   *          the desired object.
