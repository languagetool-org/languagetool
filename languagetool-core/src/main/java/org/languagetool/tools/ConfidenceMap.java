...
public class ConfidenceMap {
  ...
  private final Map<ConfidenceKey,Float> map;

  public ConfidenceMap(Map<ConfidenceKey,Float> map) {
    this.map = Objects.requireNonNull(map);
  }

  @Nullable
  public Float get(ConfidenceKey key) {
    return map.get(key);
  }
  ...
  public static class ConfidenceKey {
    Language lang;
    String ruleId;
