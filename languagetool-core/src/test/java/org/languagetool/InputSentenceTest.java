...
public class InputSentenceTest {
  ...
  public void test() throws IOException {
    ...
    InputSentence inputSentence1a = new InputSentence(lt.getAnalyzedSentence("foo"), lang, lang,
    ...
    InputSentence inputSentence1b = new InputSentence(lt.getAnalyzedSentence("foo"), lang, lang,
            new HashSet<>(Arrays.asList("ID1")), new HashSet<>(Arrays.asList(new CategoryId("C1"))),
            new HashSet<>(Arrays.asList("ID2")), new HashSet<>(Arrays.asList(new CategoryId("C2"))), userConfig1, altLanguages, mode, level);
    assertEquals(inputSentence1a, inputSentence1b);
    InputSentence inputSentence2 = new InputSentence(lt.getAnalyzedSentence("foo"), lang, null,
            new HashSet<>(Arrays.asList("ID1")), new HashSet<>(Arrays.asList(new CategoryId("C1"))),
            new HashSet<>(Arrays.asList("ID2")), new HashSet<>(Arrays.asList(new CategoryId("C2"))), userConfig1, altLanguages, mode, level);
    ...
    InputSentence inputSentence1bUserConfig2 = new InputSentence(lt.getAnalyzedSentence("foo"), lang, lang,
            new HashSet<>(Arrays.asList("ID1")), new HashSet<>(Arrays.asList(new CategoryId("C1"))),
    ...
    InputSentence inputSentence1aOtherMode = new InputSentence(lt.getAnalyzedSentence("foo"), lang, lang,
            new HashSet<>(Arrays.asList("ID1")), new HashSet<>(Arrays.asList(new CategoryId("C1"))),
    ...
    InputSentence inputSentence1aSameAltLang = new InputSentence(lt.getAnalyzedSentence("foo"), lang, lang,
            new HashSet<>(Arrays.asList("ID1")), new HashSet<>(Arrays.asList(new CategoryId("C1"))),
    ...
    InputSentence inputSentence1aOtherAltLang = new InputSentence(lt.getAnalyzedSentence("foo"), lang, lang,
            new HashSet<>(Arrays.asList("ID1")), new HashSet<>(Arrays.asList(new CategoryId("C1"))),
