...
public class MatrixTest {
    ...
    public void matrixFromListTest() {
        ...
        Matrix expectedMatrix = new Matrix(new double[][]{{1,2},{3,4},{5,6}});
    ...
    public void matMulTest() {
        ...
        final Matrix b = new Matrix(new double[][]{{1},{2}});
        final Matrix c = new Matrix(new double[][]{{5},{11},{17}});
    ...
    public void matAddTest() {
        ...
        Matrix b = new Matrix(new double[][]{{1,2},{3,4},{5,7}});
        Matrix c = new Matrix(new double[][]{{2,4},{6,8},{10,13}});
