 ...
 */
public class ArabicPartialPosTagFilter extends PartialPosTagFilter {

  private final Tagger tagger = new Arabic().getTagger();
  private final Disambiguator disambiguator = new Arabic().getDisambiguator();
