...
public class AsturianTest extends LanguageSpecificTest {
  ...
  public void testLanguage() throws IOException {
    ...
    String s = "Apega testu equí. o revisa toes les pallabres de esti testu pa ver dalgún de los problemis que LanguageTool ye pa deteutar. ¿Afáyiste con los correutores gramaticales? Has date cuenta de que entá nun son perfeutos.";
