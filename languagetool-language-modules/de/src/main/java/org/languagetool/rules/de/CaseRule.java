...
public class CaseRule extends GermanRule {
  ...
  static {
    ...
    myExceptionPhrases.add("Rote Meer");
    myExceptionPhrases.add("Rotes Meer");
    myExceptionPhrases.add("Roten Meer");
    myExceptionPhrases.add("Roten Meeres");
    myExceptionPhrases.add("Schwarze Meer");
    myExceptionPhrases.add("Schwarzes Meer");
    myExceptionPhrases.add("Schwarzen Meer");
    myExceptionPhrases.add("Schwarzen Meeres");
    ...
    myExceptionPhrases.add("Tschechische Republik");
    myExceptionPhrases.add("Tschechischen Republik");
    ...
    myExceptionPhrases.add("im Hier und Jetzt");
    myExceptionPhrases.add("Wenn und Aber");
    myExceptionPhrases.add("Letzter Wille");
    myExceptionPhrases.add("Letzte Wille");
    myExceptionPhrases.add("Letzten Willen");
    myExceptionPhrases.add("Letzten Willens");
    myExceptionPhrases.add("Goldener Schnitt");
    myExceptionPhrases.add("Goldene Schnitt");
    myExceptionPhrases.add("Goldenen Schnitt");
    myExceptionPhrases.add("Regierende Bürgermeister");
    myExceptionPhrases.add("Regierender Bürgermeister");
    myExceptionPhrases.add("Regierenden Bürgermeisters");
    myExceptionPhrases.add("Regierenden Bürgermeister");
    myExceptionPhrases.add("Erste Mai");
    myExceptionPhrases.add("Erster Mai");
    myExceptionPhrases.add("Ersten Mai");
    myExceptionPhrases.add("Ewige Stadt");
    myExceptionPhrases.add("Ewiger Stadt");
    myExceptionPhrases.add("Ewigen Stadt");
    myExceptionPhrases.add("Rote Planet");
    myExceptionPhrases.add("Roter Planet");
    myExceptionPhrases.add("Roten Planeten");
    myExceptionPhrases.add("Neue Welt");
    myExceptionPhrases.add("Neuer Welt");
    myExceptionPhrases.add("Neuen Welt");
    myExceptionPhrases.add("Große Teich");
    myExceptionPhrases.add("Großer Teich");
    myExceptionPhrases.add("Großen Teichs");
    myExceptionPhrases.add("Großen Teiches");
  }
