...
public class GermanSpellerRule extends CompoundAwareHunspellRule {
  ...
  protected boolean acceptSuggestion(String s) {
      return !PREVENT_SUGGESTION.matcher(s).matches()
        ...
        && !s.matches("[A-ZÄÖÜa-zäöüß\\-]+\\.[A-ZÄÖÜa-zäöüß][a-zäöüß\\-]+")   // e.g. "Bonzeugs.weine"
        ...
        && !s.matches("([skdm]?ein|viel|sitz|sing|web|hör|woh[nl]|adel|elektiv|wert|wein|wund|wand|weg|wett|gen|hei[lm]|kenn|vo[rnm]|fein|zu[rm]?|fehl)-[A-ZÄÖÜa-zäöüß\\-]+")   // prevent "testen-URL"
