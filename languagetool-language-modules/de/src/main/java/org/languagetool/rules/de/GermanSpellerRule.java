...
public class GermanSpellerRule extends CompoundAwareHunspellRule {
  ...
  protected boolean acceptSuggestion(String s) {
      return !PREVENT_SUGGESTION.matcher(s).matches()
        ...
        && !s.matches("[A-ZÄÖÜ][a-zäöüß]{2,20}-[a-z]{2,20}-")   // prevent Xx-zzz-
        && !s.matches("[a-zäöüß]{3,20}-[A-ZÄÖÜ][a-z]{2,20}")   // prevent "testen-Gut"
        && !s.matches("[a-zäöüß]{3,20}-[A-ZÄÖÜ]{2,20}")   // prevent "testen-URL"
        && !s.matches(".+-(gen|tu[etn]|ehren?|[fv]iele?n?|gären?|igeln?|nein|ja|d?rum|erben?|ecken?|vo[rnm]|hat|gaben|gibt|km|geben?|nu[nr]|gay|kalt|la[gd]|la[gd]en?|man|stur|rängen?|nässen?|angle|angeln?|angst|sturen|oft|wo|wann|was|wer|mengen?|spie(ß|ss)en?|adeln?|näht?en?|ob|beiden?|zweiten?|hütt?en?|kehrt?en?|h?orten?|messen?|tr[ea]u|trüb|trüben?|senden?|gr[uo]b|feinden?|wie|käsen?|ih[rmn]|grau|trug|trugen|weil|dass|sein?|zucken?|kanten?|s?ich|getan|hält|bald|ärgern?|fächern?|warten?|leid|weit|weiten?|weiden?|ruf|rufen?|min|in|im|bin|zicken?|kacken?|jo|siegeln?|[ao]ha|ganz|zäh|jäh|gehen?|ga[br]|kam|sah|[sr]itzen|kann|mit|ohne|ist|so|war|da[rh]in|über|unter|doof|bis|sie|er|aalen?|[lb]aden?|raten?|die|mit|bis|d[ea]s|eifern?|ackern?|z[iu]cken?|j[oe]|jäh|haha|gerät|[wrbfk]etten?|tja|je|kau|nach|haben?|hab|gaga|kicken?|kick|heil|heilen?|altern?|wänden?|wert|werben?|zoom|genug|gehen?|um|und|oder|[sn]ah|ha|de[mnsr]|sü(ß|ss)|ringen?|dingen?|seil|au[fs]|gurten?|munden?|eigen|wenden?|regen?|b?rechen?|legen?|fächern?|leger|g[ia]lt|heim|heimen?|[mksdw]?ein|[mksdw]?einen?|erden?|ändern?|ernten?|bänden?|ästen?|arten?|kanten?|eichen?|unken?|wunden?|kunden?|runden?|regeln?|kegeln?|krähen?|zechen?|mähen?|ehren?|ehen?|enden?|engen?|gut|guten?|ziel|zielen?|spiel|spielen?|ätzen?|riegeln?|segeln?|engt?|engen?|angeln?|kochen?|[lk]ehren?|festen?|essen?|steuern?|ekeln?|irren?|cum|de|da|du|raus|rein|dort|knien?|hin|zu[rm]?)")   // e.g. "Babysöckchen" -> "Babys-kochen"
