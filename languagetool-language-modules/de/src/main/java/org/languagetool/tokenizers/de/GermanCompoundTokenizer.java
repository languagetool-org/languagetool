...
public class GermanCompoundTokenizer implements Tokenizer {
  ...
  public GermanCompoundTokenizer(boolean strictMode) throws IOException {
    ...
    wordSplitter.addException("Flexions", asList("Flexions"));
    ...
    wordSplitter.addException("Infraschall", asList("Infraschall"));
    wordSplitter.addException("Innovations", asList("Innovations"));
    //wordSplitter.addException("Induktivitäts", asList("Induktivitäts"));
    wordSplitter.addException("Jahreszeiten", asList("Jahreszeiten"));
