...
public class GermanTaggerTest {
  ...
  public void testAdjectivesFromSpellingTxt() throws IOException {
    assertEquals("gewürftelt[gewürftelt/PA2:PRD:GRU:VER]", toSortedString(tagger.lookup("gewürftelt")));
    assertEquals("gewürfteltes[gewürftelt/PA2:AKK:SIN:NEU:GRU:IND:VER, " +
      "gewürftelt/PA2:AKK:SIN:NEU:GRU:SOL:VER, gewürftelt/PA2:NOM:SIN:NEU:GRU:IND:VER, " +
      "gewürftelt/PA2:NOM:SIN:NEU:GRU:SOL:VER]", toSortedString(tagger.lookup("gewürfteltes")));
