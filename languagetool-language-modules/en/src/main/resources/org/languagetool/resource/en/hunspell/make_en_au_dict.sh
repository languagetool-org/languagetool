...
hunspell -d en_AU -G en_AU1.txt | java -cp languagetool.jar:languagetool-dev-4.5-SNAPSHOT.jar org.languagetool.dev.archive.WordTokenizer en | sort -u > en_AU.txt
