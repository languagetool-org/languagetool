...
hunspell -d en_CA -G en_CA1.txt | java -cp languagetool.jar:languagetool-dev-4.2-SNAPSHOT.jar org.languagetool.dev.archive.WordTokenizer en | sort -u > en_CA.txt
