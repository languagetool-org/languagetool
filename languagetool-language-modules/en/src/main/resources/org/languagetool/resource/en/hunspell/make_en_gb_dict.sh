...
cat en_GB1.txt spelling_merged.txt| java -cp languagetool.jar:languagetool-dev-4.9-SNAPSHOT.jar org.languagetool.dev.archive.WordTokenizer en | sort -u > en_GB.txt
