...
hunspell -d en_GB -G en_GB1.txt | java -cp languagetool.jar:languagetool-dev-4.4-SNAPSHOT.jar org.languagetool.dev.archive.WordTokenizer en | sort -u > en_GB.txt
