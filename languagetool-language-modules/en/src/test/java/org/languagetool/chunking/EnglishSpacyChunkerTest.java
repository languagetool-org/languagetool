...
public class EnglishSpacyChunkerTest {

  @Test
  public void testAddChunkTags() {
    EnglishSpacyChunker chunker = new EnglishSpacyChunker();
    ...
    // "A short test":
    assertThat(readingsList.get(0).getChunkTags().toString(), is("[s:B-NP-singular]"));
    assertThat(readingsList.get(2).getChunkTags().toString(), is("[s:I-NP-singular]"));
    assertThat(readingsList.get(4).getChunkTags().toString(), is("[s:E-NP-singular]"));
    // "the bicycle":
    assertThat(readingsList.get(8).getChunkTags().toString(), is("[s:B-NP-singular]"));
    assertThat(readingsList.get(10).getChunkTags().toString(), is("[s:E-NP-singular]"));
    // "is needed"
    assertThat(readingsList.get(12).getChunkTags().toString(), is("[s:B-VP]"));
    assertThat(readingsList.get(14).getChunkTags().toString(), is("[s:I-VP]"));
  }
  ...
  public void testAddChunkTagsSingular() throws Exception {
    ...
    chunker.addChunkTags(readingsList);
    // "The abacus":
    assertThat(readingsList.get(1).getChunkTags().toString(), is("[B-NP-singular, s:B-NP-singular, s:B-NP-singular]"));  // TODO: duplicate?!
    assertThat(readingsList.get(3).getChunkTags().toString(), is("[E-NP-singular, s:E-NP-singular, s:E-NP-singular]"));
    // "numbers":
    assertThat(readingsList.get(9).getChunkTags().toString(), is("[B-NP-plural, E-NP-plural, s:B-NP-plural, s:E-NP-plural, s:B-NP-plural, s:E-NP-plural]"));
  }
  ...
  public void testContractions() throws Exception {
    ...
    assertThat(tokens[1].getChunkTags().get(1), is(new ChunkTag("E-NP-singular")));
    assertThat(tokens[1].getChunkTags().get(2), is(new ChunkTag("s:B-NP-singular")));
    assertThat(tokens[1].getChunkTags().get(3), is(new ChunkTag("s:E-NP-singular")));

    assertThat(tokens[2].getChunkTags().get(0), is(new ChunkTag("B-VP")));
    assertThat(tokens[2].getChunkTags().get(1), is(new ChunkTag("s:B-VP")));

    assertThat(tokens[4].getChunkTags().get(0), is(new ChunkTag("I-VP")));
    assertThat(tokens[4].getChunkTags().get(1), is(new ChunkTag("s:I-VP")));
  }
  ...
  @NotNull
  private List<String> getChunksAsString(String input, EnglishSpacyChunker chunker, JLanguageTool lt) throws IOException {
