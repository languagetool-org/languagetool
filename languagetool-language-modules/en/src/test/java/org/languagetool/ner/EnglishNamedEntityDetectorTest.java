...
public class EnglishNamedEntityDetectorTest {
  ...
  public void testNamedEntities() {
    ...
    //String[] tokens = ner.tokenize("Dear Tarsem Singh, how are you?");  // 'Tarsem' not close to anything
    ...
    assertThat(s.substring(namedEntities.get(0).getStart(), namedEntities.get(0).getEnd()), is("Valide Sultan Gülbahar Hatun"));
  }
