...
public class MorfologikAustralianSpellerRuleTest extends AbstractEnglishSpellerRuleTest {
  ...
  public void testMorfologikSpeller() throws IOException {
    ...
    Assertions.assertEquals(0, rule.match(lt.getAnalyzedSentence("My fiancée")).length);  // check encoding isn't broken, spelling_merged.txt
    //with doesn't
    ...
    //Australian dict:
    Assertions.assertEquals(0, rule.match(lt.getAnalyzedSentence("Dinkum")).length);
