 ...
 * @since 2.7
 */
public class SimpleReplaceCaseInsensitiveRule extends AbstractSimpleReplaceRule2 {

  public static final String DUTCH_SIMPLE_REPLACE_RULE = "NL_SIMPLE_REPLACE_CASE_INSENSITIVE";
  
  private static final Locale NL_LOCALE = new Locale("nl");

  public SimpleReplaceCaseInsensitiveRule(ResourceBundle messages) throws IOException {
    super(messages, new Dutch());
    //useSubRuleSpecificIds();
    setLocQualityIssueType(ITSIssueType.Misspelling);
    setCategory(new Category(new CategoryId("VERGISSINGEN"), "Vergissingen"));
    addExamplePair(Example.wrong("<marker>een Bisschop</marker>."),
                   Example.fixed("<marker>een bisschop</marker>."));
  ...
  public List<String> getFileNames() {
    return Collections.singletonList("/nl/replace-case-insensitive.txt");
  }
