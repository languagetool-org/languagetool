...
public class DateCheckFilterTest {
  ...
  public void testAccept() throws Exception {
    assertNull(filter.acceptRuleMatch(match, makeMap("2014", "8" ,"23", "zaterdag"), -1, null, null));  // correct date
    assertNotNull(filter.acceptRuleMatch(match, makeMap("2014", "8" ,"23", "zondag"), -1, null, null));  // incorrect date
  }
