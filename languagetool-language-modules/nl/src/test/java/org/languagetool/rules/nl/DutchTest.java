...
public class DutchTest extends LanguageSpecificTest {
  ...
  public void testLanguage() throws IOException {
    ...
    testDemoText(lang, s,
      Arrays.asList("CHECKEN", "MORFOLOGIK_RULE_NL_NL", "MORFOLOGIK_RULE_NL_NL", "MORFOLOGIK_RULE_NL_NL", "ZO_OPTIMAAL_MOGELIJK", "UPPERCASE_SENTENCE_START", "SPATIE_LEESTEKEN", "NL_SIMPLE_REPLACE_MUSTHAVE", "BIJ_VOORBEELD", "DATE_WEEKDAY")
    );
