...
public class JLanguageToolTest extends TestCase {
  ...
  public void testPolish() throws IOException {
    ...
    assertEquals("Disambiguator log: \n" +
            ...
            "SUBST_NOM_VOC_VERB[5]: buty[but/subst:pl:nom:m2,but/subst:pl:nom:m3,buta/subst:pl:nom:f] -> buty[but/subst:pl:nom:m2,but/subst:pl:nom:m3,buta/subst:pl:nom:f]\n" +
            "\n" +
