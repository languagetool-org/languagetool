  ...
  public void testCompoundFile() throws IOException {
    ...
    for (String line : lines) {
      ...
      if (line.endsWith("+")) {
        ...
        Assertions.assertEquals(0, ruleMatches.length, "The entry: " + line + " is not found in the spelling dictionary!");
        ...
        Assertions.assertEquals(0, spellRule.match(lt.getAnalyzedSentence(line)).length, "The entry: " + line + " is not found in the spelling dictionary!");
        Assertions.assertEquals(0, spellRule.match(lt.getAnalyzedSentence(line.replace("-", ""))).length, "The entry: " + line.replace("-", "") + " is not found in the spelling dictionary!");
      }
    }
  }
