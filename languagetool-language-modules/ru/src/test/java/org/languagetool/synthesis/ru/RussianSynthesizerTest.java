...
public class RussianSynthesizerTest {
  ...
  public final void testSynthesizeString() throws IOException {
    ...
    Assertions.assertEquals("[семья]", Arrays.toString(synth.synthesize(dummyToken("семья"), "NN:Inanim:Fem:Sin:Nom")));
    Assertions.assertEquals("[семьи]", Arrays.toString(synth.synthesize(dummyToken("семья"), "NN:Inanim:Fem:Sin:R")));
  }
