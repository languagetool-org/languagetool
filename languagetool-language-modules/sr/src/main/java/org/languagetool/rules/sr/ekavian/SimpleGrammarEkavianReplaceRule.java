 ...
 * <code>/sr/dictionary/ekavian/replace-grammar.txt</code>.
 *
 * @author Zoltan Csala
 * @since 4.0
 */
public class SimpleGrammarEkavianReplaceRule extends AbstractSimpleReplaceRule {
  ...
  private static final Map<String, List<String>> wrongWords = load("/sr/dictionary/ekavian/replace-grammar.txt");
  ...
  public final String getId() {
    return "SR_EKAVIAN_SIMPLE_GRAMMAR_REPLACE";
  }
