...
/**
 * Originally proposed for LanguageTool upstream by Leif-Jöran Olsson
 * (github.com/languagetool-org/languagetool PR #9042), ported here with the
 * actual confusion_sets.txt data that PR left unfinished.
 *
 * @since 2.7
 */
