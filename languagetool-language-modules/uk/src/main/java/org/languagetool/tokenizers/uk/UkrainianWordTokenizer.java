...
//      text = ABBR_DOT_INVALID_DOT_PATTERN.matcher(text).replaceAll("$1" + NON_BREAKING_DOT_SUBST + "$2");
      ...
      text = ABBR_DOT_NON_ENDING_PATTERN_2.matcher(text).replaceAll("$1" + NON_BREAKING_DOT_SUBST + "$2");
    }
