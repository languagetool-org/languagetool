...
/**
 * The tests of SChineseSentenceTokenizer
 *
 * @author Ze Dang
 */

public class SChineseSentenceTokenizerTest {

    private final SentenceTokenizer stokenizer = new SChineseSentenceTokenizer();
    ...
    public void testSymbol() {
        ...
        for (char i : punctuation1) {
            testSplit(t2 + i + t3);// e.g. 我们是中国人_中国人很好
        }
        ...
        for (char i : punctuation2) {
            testSplit(t2 + i, t3); // e.g. 我们是中国人，|中国人很好
        }
        ...
        for (int i = 0; i < punctuation3.length / 2; i++) {
            testSplit(t1 + punctuation3[i] + t2 + "，", t3
                    + punctuation3[punctuation2.length - 1 - i]); // e.g. 他说："我们是中国人，|中国人很好"
        }
        ...
        for (int i = 0; i < punctuation4.length / 2; i++) {
            testSplit(t1 + punctuation4[i] + t2 + "，", t3
                    + punctuation4[punctuation4.length - 1 - i]); // e.g. 他说〝我们是中国人，|中国人很好〞
        }
    }
