...
ictclas4j-1.0.jar: Apache-License.txt, Apache License 2.0, http://code.google.com/p/ictclas4j/
...
lucene-core|queries|test-framework.jar: Apache License 2.0, http://lucene.apache.org
