...
class V2TextChecker extends TextChecker {
  ...
  V2TextChecker(HTTPServerConfig config, boolean internalServer, Queue<Runnable> workQueue, AtomicInteger handleCount) {
    super(config, internalServer, workQueue, handleCount);
  }
