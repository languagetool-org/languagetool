...
public class RemoteSynthesizerTest {
  ...
  public void testSynthesis() throws Exception {
    ...
    assertEquals(remoteSynth.synthesize("fr", "chanter","V ppa.*", true).toString(), "[chantées, chantée, chantés, chanté]");
    ...
    assertEquals(remoteSynth.synthesize("es", atrs2, true, "AQ0(.)(.).", "V.P..$2$1", "extrañar").toString(), "[extrañado]");
