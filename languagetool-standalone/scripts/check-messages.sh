...
do
    ...
    mv vim.tmp $target/result/${LAN}_diff.html
    sed -i 's/\*\*/<b>/' $target/result/${LAN}_diff.html
    sed -i 's/\*\*/<\/b>/' $target/result/${LAN}_diff.html
    sed -i 's/monospace; color: #....../monospace; color: #cccccc/' $target/result/${LAN}_diff.html
    sed -i 's/Identifier { color: #....../Identifier { color: #000000/' $target/result/${LAN}_diff.html
    sed -i 's/Statement { color: #....../Statement { color: #cccccc/' $target/result/${LAN}_diff.html
