...
public class MultiLanguageTest {
  ...
  private static List<String> ENGLISH_SENTENCES = Arrays.asList("He is a very cool guy from Poland.", "How are you?", "But this is English.");
  ...
  public void testWithPreferredLanguagesDeAndEn() throws IOException {
    ...
    for (String sentence : ENGLISH_SENTENCES) {
      ...
      for (RuleMatch match : matches) {
        System.out.println(match + " " + sentence + " " + match.getErrorLimitLang());
