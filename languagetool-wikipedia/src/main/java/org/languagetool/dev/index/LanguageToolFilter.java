...
public final class LanguageToolFilter extends TokenFilter {
  ...
  public boolean incrementToken() throws IOException {
    ...
    // Looped rather than recursed so that long runs of whitespace tokens don't
    // blow the stack (previously a whitespace token recursed into incrementToken(),
    // which caused a StackOverflowError on sentences with many consecutive spaces).
    while (true) {
