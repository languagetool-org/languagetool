...
class StoredWikipediaRuleMatch {
  ...
  StoredWikipediaRuleMatch(String ruleId, String ruleSubId, String ruleMessage, String errorContext, String title, Date editDate, Date fixDate, long diffId, long fixDiffId) {
