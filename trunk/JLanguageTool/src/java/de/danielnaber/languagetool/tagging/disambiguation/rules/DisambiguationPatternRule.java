 ...
 */
public class DisambiguationPatternRule extends Rule {
  ...
  DisambiguationPatternRule(final String id, final Language language, final List<Element> elements, final String description,
