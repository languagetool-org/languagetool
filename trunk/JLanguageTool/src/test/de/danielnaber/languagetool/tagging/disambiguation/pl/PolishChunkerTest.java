...
public class PolishChunkerTest extends TestCase {
    ...
    public void testChunker() throws IOException {
      ...
      TestTools.myAssert("To test... dezambiguacji","/[null]SENT_START To/[to]conj|To/[ten]adj:sg:nom.acc.voc:n1.n2:pos  /[null]null test/[test]subst:sg:nom.acc:m3|test/[testo]subst:pl:gen:n ./[...]<ELLIPSIS> ./[null]null ./[...]</ELLIPSIS>  /[null]null dezambiguacji/[null]null", tokenizer, sentenceTokenizer, tagger, disambiguator);
      TestTools.myAssert("On, to znaczy premier, jest niezbyt mądry","/[null]SENT_START On/[on]ppron3:sg:nom:m1.m2.m3:ter ,/[null]null  /[null]null to/[to]conj|to/[ten]adj:sg:nom.acc.voc:n1.n2:pos|to/[to znaczy]<TO_ZNACZY>  /[null]null znaczy/[znaczyć]verb:fin:sg:ter:?perf|znaczy/[to znaczy]</TO_ZNACZY>  /[null]null premier/[premier]subst:sg:nom.acc:m3|premier/[premiera]subst:pl:gen:f ,/[null]null  /[null]null jest/[być]verb:fin:sg:ter:imperf  /[null]null niezbyt/[zbyt]adv:neg  /[null]null mądry/[mądry]adj:sg:nom:m:pos|mądry/[mądry]adj:sg:nom:m:pos:aff", tokenizer, sentenceTokenizer, tagger, disambiguator);
      TestTools.myAssert("Lubię go z uwagi na krótkie włosy.","/[null]SENT_START Lubię/[lubić]verb:fin:sg:pri:?perf  /[null]null go/[on]ppron3:sg:gen:m1.m2.m3.n1.n2:ter:nakc:npraep|go/[on]ppron3:sg:acc:m1.m2.m3:ter:nakc:npraep  /[null]null z/[z]prep:gen.inst|z/[z uwagi na]<PREP:ACC>  /[null]null uwagi/[uwaga]subst:sg:gen.dat.loc:f|uwagi/[uwaga]subst:pl:gen:f  /[null]null na/[na]prep:acc.loc|na/[z uwagi na]</PREP:ACC>  /[null]null krótkie/[krótki]adj:pl:nom.acc.voc:m2.m3.n1.n2.f:pos:aff|krótkie/[krótki]adj:sg:nom.acc:n1.n2:pos:aff  /[null]null włosy/[włosy]subst:pltant:nom:m|włosy/[włos]subst:pl:nom.voc:m ./[null]null", tokenizer, sentenceTokenizer, tagger, disambiguator);
    }
