...
public class PolishChunkerTest extends TestCase {
    ...
    public void testChunker() throws IOException {
      ...
      TestTools.myAssert("Lubię go z uwagi na krótkie włosy.","/[null]SENT_START Lubię/[lubić]verb:fin:sg:pri:imperf  /[null]null go/[on]ppron3:sg:gen:m1.m2.m3.n:ter:nakc:npraep|go/[on]ppron3:sg:acc:m1.m2.m3:ter:nakc:npraep  /[null]null z/[z]prep:gen.inst|z/[z uwagi na]<PREP:ACC>  /[null]null uwagi/[uwaga]subst:sg:gen.dat.loc:f  /[null]null na/[na]prep:acc.loc|na/[z uwagi na]</PREP:ACC>  /[null]null krótkie/[krótki]adj:sg:nom.acc.voc:n:pos:aff|krótkie/[krótki]adj:pl:nom.acc.voc:f.n.m2.m3:pos:aff  /[null]null włosy/[włosy]subst:pltant:nom.acc.voc:n|włosy/[włos]subst:pl:nom.acc.voc:m ./[null]null", tokenizer, sentenceTokenizer, tagger, disambiguator);
    }
