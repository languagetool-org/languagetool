...
public class EnglishRuleDisambiguatorTest extends TestCase {
  ...
  public void testChunker() throws IOException {
    ...
    TestTools.myAssert("He is to blame.",
        ...
        tokenizer, sentenceTokenizer, tagger, disambiguator);
    TestTools.myAssert("He is to blame.",
        "/[null]SENT_START He/[he]PRP  /[null]null is/[be]VBZ  /[null]null to/[to]IN|to/[to]TO  /[null]null blame/[blame]NN:UN|blame/[blame]VB|blame/[blame]VBP|blame/[blame]JJ ./[null]null", 
        tokenizer, sentenceTokenizer, tagger, disamb2);
