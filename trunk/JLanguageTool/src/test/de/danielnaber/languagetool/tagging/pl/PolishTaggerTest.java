  ...
  public void testDictionary() throws IOException {
	...
	public void testTagger() throws IOException {
	  TestTools.myAssert("To jest duży dom.",
	      "To/[ten]adj:sg:nom.acc.voc:n:pos|To/[to]conj -- jest/[być]verb:fin:sg:ter:imperf -- duży/[duży]adj:sg:nom.acc:m3:pos:aff|duży/[duży]adj:sg:nom.voc:m1.m2:pos:aff -- dom/[dom]subst:sg:nom.acc:m3", tokenizer, tagger);
