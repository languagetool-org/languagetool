...
<p><strong>Update 2007-05-20:</strong> Released version 0.9:
Supports easier rule editing, added more rules for French, improved recognition
of German compound nouns, added XML disambiguation rules, made improvements
to the rule syntax, added initial support for Slovenian, improved rules
for Polish, English, and Spanish.
See the <?=show_link("Changelog", "download/CHANGES.txt", 0) ?> for details.</p>

<p><strong>Download:</strong><br />
<strong><?=show_link("LanguageTool 0.9", "download/LanguageTool-0.9.zip", 0) ?></strong>, 9&nbsp;MB,
...
<ul>
	...
	to install <tt>LanguageTool-0.9.zip</tt> (note that the menu item is called <em>Package Manager</em>
